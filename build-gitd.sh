...
AGENT_H="$SRC/agent_src.h"
{
    echo "/* Generated by build-gitd.sh from BP/GIT.AGENT — do not edit. */"
...
echo "embedded BP/GIT.AGENT -> $(basename "$AGENT_H") ($(wc -l < "$HERE/BP/GIT.AGENT") lines)"
